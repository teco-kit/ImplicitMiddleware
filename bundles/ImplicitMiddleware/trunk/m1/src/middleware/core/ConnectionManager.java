...
public class ConnectionManager {
	...
	public SendReceive getConnection(String host)
	{
		...
		{
			Hashtable threadConnections = (Hashtable)connections.get(host);
			Connection conn = (Connection)threadConnections.get(Thread.currentThread());
	...
	/**
	 * Add a connection that has been established without the use of the ConnectionManager, 
	 * e.g. a server connection.
	 * @param sr
	 */
...
//	{
//		Connection key = new Connection(host, Thread.currentThread());
//		SendReceive sr = connections.get(key);
//		if (sr.isConnected())
//			sr.disconnect();
